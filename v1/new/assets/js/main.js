(function(){
    ...
    App.elements.$absCentered = $('#abs-centered');
    ...
    App.helpers.init = function() {
        var absHeight = App.elements.$absCentered.outerHeight(),
            absWidth = App.elements.$absCentered.outerWidth();
        App.elements.$absCentered.css({
            'margin-left' : '-' + absWidth / 2 + 'px',
            'margin-top' : '-' + absHeight / 2 + 'px',
            'width' : absWidth + 'px',
            'height' : absHeight + 'px'
        }).addClass('abs-centered');
    ...
    $('a[href^="#"]').on('click', function(e){
        ...
        if (App.variables.skrollrInstance !== false && isMobile && href === '#top'){
