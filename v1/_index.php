...
<div id="center">
	<ul>
		<li id="writer-box"><a href="#<?php echo $writer['h1']; ?>"><?php echo $center['writer']; ?></a></li>
		<li id="developer-box"><a href="#<?php echo $developer['h1']; ?>"><?php echo $center['developer']; ?></a></li>
		<li id="photographer-box"><a href="#<?php echo $photographer['h1']; ?>"><?php echo $center['photographer']; ?></a></li>
	</ul>
</div> 
...
<p class="submit">
	<input type="button" name="submit" class="button green" id="submit_btn" tabindex="5" value="Pošalji" />
</p>
</fieldset>
</form>
